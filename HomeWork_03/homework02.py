...
p1_1 = (comb(5, 0)*comb(3, 3)/comb(8, 2)) * (comb(5, 3)*comb(7, 1)/comb(12, 4))
# вероятность, что из первого ящика 1, а из второго 3
p1_2 = (comb(5, 1)*comb(3, 2)/comb(8, 2)) * (comb(5, 3)*comb(7, 1)/comb(12, 4))
# вероятность, что из первого ящика 0 или 1 белый мяч, а из второго 3
p1 = p1_1 + p1_2


# вероятность того, что первый ящик может содержать белый мяч под номером 1, а второй ящик - белые 2 и 3
p2_1 = (comb(5, 1)*comb(3, 1)/comb(8, 2)) * (comb(5, 2)*comb(7, 2)/comb(12, 4))
# вероятность того, что первый ящик может содержать белый мяч под номером 2, а второй ящик - белые 1 и 2
